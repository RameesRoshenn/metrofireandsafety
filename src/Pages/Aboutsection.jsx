    ...
    <div>
      ...
      <div className="row row-1" >
        <div className="col-xs-12 col-md-6 about-text">
          ...
          <br />
          For over 23 years we have been in the industry and keeping our clients happy and satisfied. We offer solution for all kind of NBC categorized building structures. We have designed, and commissioned Fire protection, Gas systems in numerous prestigious projects.
          <br />
